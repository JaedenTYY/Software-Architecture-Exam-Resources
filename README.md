...
Answers must perform the requested work rather than only describe how to answer. The correction policy supplies direct, scenario-specific model answers across architectural patterns, design patterns, quality-driven decisions, requirements, views/documentation, ADD, testing, evaluation and integrated multi-part practice. All 672 Original Quality Attribute questions include worked observations or complete six-part examples; all 32 standalone Utility Tree questions include four concrete rated leaves; and integrated Q2 answers reuse their exact four six-part scenarios as rated Utility Tree leaves. The generated-content audit rejects delegated subparts, incomplete multi-part answers and any scenario-bearing prompt whose answer fails to apply the named scenario.
