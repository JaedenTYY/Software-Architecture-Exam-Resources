(() => {
  ...
  const concepts = [
    ...
    { id: "atam", label: "ATAM", category: "framework", aliases: ["atam","architecture tradeoff analysis method","architecture trade-off analysis method","nine steps","present business drivers","generate utility tree","analyze architectural approaches","brainstorm prioritize scenarios","architecture evaluation method"], related: ["utility-tree","sensitivity-point","trade-off-point","risk-theme","architectural-risk"] },
    ...
    { id: "implementation-conformance", label: "Implementation Conformance", category: "testing", aliases: ["implementation conformance","architecture code conformance","architecture-code conformance","implementation violates architecture","detect architecture violations","enforce layering in code","architectural constraints in implementation"] , related: ["architecture-testing","dependency","layer"] },
